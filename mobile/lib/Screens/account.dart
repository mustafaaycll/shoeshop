...
import 'Authentication/changename.dart';
                      ...
                      child: OutlinedButton(
                        ...
                        child: Align(
                          ...
                          child: Text("Orders", style: TextStyle(
                            color: IfInactive(customer.method),
                            fontSize: 16
                          ),
                          ),
                        ),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        ...
                        child: Align(
                          alignment: Alignment.centerLeft,
                          child: Text("Comments & Reviews", style: TextStyle(
                            color: IfInactive(customer.method),
                            fontSize: 16
                          ),
                          ),
                      ...
                      child: OutlinedButton(
                        onPressed: () {
                          if(customer.method != "anonymous"){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ChangeName(analytics: FirebaseAnalytics.instance, observer: FirebaseAnalyticsObserver(analytics: FirebaseAnalytics.instance))));
                          }
                        },
                        child: Align(
                          alignment: Alignment.centerLeft,
                        ...
                        onPressed: () {
                          if(customer.method != "anonymous"){
                            showDialog(context: context, builder: (BuildContext context){
                              return AlertDialog(
                                title: Text("We will send you an email to change your password",
                                style: TextStyle(
                                ...
                                actions: [
                                  ...
                                  child: Text("Yes", style: TextStyle(color: AppColors.positive_button),)
                                  ),
                                  TextButton(onPressed: (){
                                    Navigator.of(context).pop(); 
                                  }, 
                                  child: Text("No", style: TextStyle(color: AppColors.negative_button),)
                                  )
                                ],
                              );
                            });
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        ...
                        child: Align(
                          alignment: Alignment.centerLeft,
                          child: Text("Adresses", style: TextStyle(
                            color: IfInactive(customer.method),
                            fontSize: 16
                          ),
                          ),
