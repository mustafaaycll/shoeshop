...
class ProductPage extends StatefulWidget {
  ...
  const ProductPage({Key? key, required this.seller, required this.productID}) : super(key: key);
                      ...
                      children: [
                                                          ...
                                                          return Card(
                                                            child: ListTile(
                                                              ...
                                                              subtitle: Column(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                      "${commenter.fullname} on ${DateFormat('dd-MM-yyyy').format(comments[j].date)}",
                        ...
                        ListTile(
                          ...
                          trailing: product.quantity != 0
                                                ...
                                                itemBuilder: (context, index) {
                                                  return Card(
                                                      ...
                                                      child: ListTile(
                                                        onTap: () async {
                                                          ...
                                                          if (customer.basketMap.isEmpty) {
                                                            ...
                                                            showDialog(
                                                              ...
                                                              customer.basketMap[product.id][0] <
                                                        ...
                                                        leading: Container(
                                                          decoration: BoxDecoration(
                                                              color: AppColors.title_text, borderRadius: BorderRadius.all(Radius.circular(10))),
                                                          height: 50,
                                                          width: 50,
                                                          child: Center(
                                                            child: Text(
                              ...
                              : OutlinedButton.icon(
                                  style:
                                      ShapeRules(bg_color: AppColors.negative_button, side_color: AppColors.negative_button).outlined_button_style(),
                                  onPressed: () {},
                                  icon: Icon(
